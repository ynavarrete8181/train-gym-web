    ...
    return (
      <Box className="page-wrapper">
        <PageHeader
          ...
          descripcion="Configuración de tarifa y duración del plan"
              ...
              <Box sx={formStyles.seccion}>
                ...
                <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: '1fr 2fr' }, gap: 1.5 }}>
                  ...
                  <TextField
                    ...
                    required
                    size="small"
                    helperText="Ej: Mensualidad Pesas Premium"
                  />
                </Box>
                <Box sx={{ mt: 1.5 }}>
                  <TextField
              ...
              <Box sx={formStyles.seccion}>
                ...
                <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: 'repeat(4, 1fr)' }, gap: 1.5, alignItems: 'start' }}>
                  ...
                  <TextField
                    ...
                    name="tarifa_inscripcion"
                    type="number"
                    value={formData.tarifa_inscripcion}
                    onChange={handleChange}
                    size="small"
                    helperText="Opcional"
                  />
                ...
                <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ mb: 1 }}>
                  <Box>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      Opcional. Si una sede no tiene precio propio, se usa el Precio Base de arriba.
                    </Typography>
                  </Box>
                  <Button size="small" startIcon={<AddOutlinedIcon />} onClick={handleAddPrecioSede}>
                    Agregar precio
                  </Button>
                </Stack>
                {(formData.precios_sede || []).length === 0 ? (
                  <Typography variant="body2" color="text.secondary">
                    Este plan usa el mismo precio (${Number(formData.precio_base || 0).toFixed(2)}) en todas las sedes.
                  </Typography>
                ) : (
                  <Stack spacing={1}>
                    {(formData.precios_sede || []).map((fila, index) => (
                      ...
                      >
                        <TextField
                          ...
                          size="small"
                          value={fila.sede_id || ''}
                          onChange={(e) => handleUpdatePrecioSede(index, 'sede_id', e.target.value)}
                          sx={{ flex: 1 }}
                        >
                          {sedes.map((sede) => (
                        ...
                        <TextField
                          ...
                          size="small"
                          value={fila.precio}
                          onChange={(e) => handleUpdatePrecioSede(index, 'precio', e.target.value)}
                          sx={{ width: 140 }}
                        />
                        <Tooltip title="Quitar">
                          <IconButton size="small" onClick={() => handleRemovePrecioSede(index)}>
  ...
  return (
    <Box className="page-wrapper">
      <PageHeader
        ...
        descripcion="Administra las suscripciones que ofreces en tu gimnasio"
