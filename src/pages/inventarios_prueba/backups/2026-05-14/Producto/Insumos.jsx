...
import CompInventarioInicial from "../Stock/InventariosIniciales";
...
const Insumos = ({ usr_id }) => {
  ...
  const handleGuardarInsumos = async () => {
    ...
    try {
      const response = await AxGuardarInsumos(formDataAgregarInsumos);
  ...
  const handleModificarInsumo = async () => {
    ...
    setSavingInsumo(true);
    try {
      const response = await AxModificarInsumo(
        selectedInsumo.id,
        formDataAgregarInsumos
      );
  ...
  const handleEliminarProducto = async (id) => {
    ...
    try {
      const response = await AxEliminarInsumo(id);
  ...
  const handleViewLotesSwal = async (insumo) => {
    ...
    try {
      const response = await AxGetStockBodegaInsumo(insumo.id);
